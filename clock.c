...
/*
license:
	Делай что хочешь, как хочешь но при публикации на каких либо сайтах оставлять ссылку на первоисточник GitHub


Контакты:
	VK: 	vk.me/isupov_andrey
	Email:	isupov_andrey@icloud.com

Буду благодарен если оптимизируете и добавите в код ваш функционал.
Повторил устройство? Пришли фото автору проекта в Вконтакте
